"""
task_manager.py - File-based persistent task management.

Each task is stored as an individual JSON file (``task_*.json``) with
support for status transitions, dependency graphs, and ownership.
"""

import json
from pathlib import Path

from agents.config import TASKS_DIR
